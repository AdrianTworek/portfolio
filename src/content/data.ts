    ...
    entries: [
      {
        ...
        responsibilities: [
          ...
          `Implemented comprehensive tree structure holding several data types.`,
          `Integrated real-time workflows (tree events, chat messages, activity feed tracking).`,
          `Built background processing with Celery and Redis for async workflows (e.g. AI image classification).`,
          `Implemented a scalable tagging system for asset management - partially AI-driven.`,
          ...
          `Managed infrastructure configuration using Terraform modules and multiple environments (testing, staging, production, customer-related).`,
